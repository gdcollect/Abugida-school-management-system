  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Teachers Account  Management</a></li>
	...
	if ( isset($_POST['btn-signup']) ) {
		...
		if ( !filter_var($email,FILTER_VALIDATE_EMAIL) ) {
			...
			$query = "SELECT userEmail FROM teacher WHERE userEmail='$email'";
			...
			$query = "SELECT userId FROM teacher WHERE userId='$userId'";
			$result = mysqli_query($con,$query);
			$count = mysqli_num_rows($result);
			if($count!=0){
				$error = true;
		...
		if( !$error ) {
			...
			$query = "INSERT INTO teacher(userId,userName,userEmail,userPass) VALUES('$userId','$name','$email','$password')";
...
?>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Create New Teacher Account </h3>
            </div>
            <div class="box-body">
              <!-- Date dd/mm/yyyy -->
 ...
 <form method="post"   action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">All Teacher Account </h3>
            </div>
            <div class="box-body">
              <!-- Date -->
...
echo '<td width=25>';
            ...
            echo '<a class="btn btn-danger btn-sm"  href="delete_teach_acc.php?userId='.$row['userId'].'"><i class="glyphicon glyphicon-remove"> </i>&nbsp;Delete</a>';
            echo "</div>";
            echo '</td>';    
           echo '</tr>';  			
