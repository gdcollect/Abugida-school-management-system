...
?>
	...
	<div class="box box-primary">
 		...
 		<button type="button" onclick="window.print()" class="btn bg-navy btn-flat  "><i class="glyphicon glyphicon-print"></i>&nbsp;&nbsp; Print/Export PDF</button>
 		  <a href="../../core/teacher/AttendenceReport.php"  class="btn bg-primary btn-flat  "><i class="glyphicon glyphicon-repeat"></i>&nbsp; Back </a> 
 		  <a href="../../core/teacher/do_attendance.php"  class="btn bg-purple btn-flat  "><i class="glyphicon glyphicon-refresh"></i>&nbsp; &nbsp; Refrash</a> 
		  <br>
<br>
