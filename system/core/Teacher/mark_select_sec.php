<?php  require 'top.php';?>
		  ...
		  <br>   <br>
		   ...
		   ?>
            <div class="box-header btn   btn-flat ">
              <h3 class="box-title"style="color:grey"  >Section <?php  echo $sec ?>  Mark list in Grade <?php  echo $_GET ['grade']?> </h3>
            </div>
 ...
 <div class="nav-tabs-custom">
		 ...
		 $select = "SELECT * FROM `marklist` WHERE subject='$subject1'  AND sec='$sec'  AND grade=".$_GET ['grade'];
