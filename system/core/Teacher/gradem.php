        ...
        <div class="col-xs-12">
         ...
         <div class="box box-primary">
          ...
          <div class="box box-solid">
 		  ...
 		  <a href="../../core/teacher/all_mark_list.php"  class="btn bg-purple btn-flat  "><i class="glyphicon glyphicon-plus"> </i> Add New </a> 
		<button type="button" onclick="window.print()" class="btn bg-navy btn-flat  ">Print/Export PDF</button>
 		  <a href="../../core/teacher/all_mark_list.php"  class="btn bg-purple btn-flat  "><i class="glyphicon glyphicon-arrow-left"> </i> Back </a> 
...
<div class="nav-tabs-custom">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#First" data-toggle="tab">First Semister</a></li>
		
		<li class=""><a href="#Second" data-toggle="tab">Second Semister</a></li>
...
<div class="tab-content">
	<div class="tab-pane active" id="First">
		...
		<?php       	  
			...
			$grade=$_GET['grade'];
			$select = "SELECT * FROM `marklist` WHERE grade='$grade' AND `teacher`='$userId'  " ;
...
<?php        
				...
				$con = mysqli_connect($host,$user,$password,$db);
				$select = "SELECT * FROM `marklist` WHERE `teacher`='$userId'  " ;
