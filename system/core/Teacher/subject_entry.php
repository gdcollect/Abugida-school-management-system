 ...
 <div class="box box-default">
    ...
    <div class="row">
      ...
      ?>
          ...
          <div class="form-group">
            <select style="color:grey" class="form-control" required id="Section" name="Section">
      ...
      ?>
      <?php	
      echo "<select style='color:grey' class='form-control' name='id' >
...
<br><br><br><br> <br> 
    ...
    $id = $_POST['id'];
      ...
      $teacher_name	= $_POST['id'];
      $grade = $_POST['grade'];
      $Section= $_POST['Section'];

		   
	
	$insert = "INSERT INTO `subject_table` VALUES ('$id','$subject_name','$teacher_name','$grade','$Section' )";
