  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Students Account  Management</a></li>
	...
	if ( isset($_POST['btn-signup']) ) {
		...
		if ( !filter_var($email,FILTER_VALIDATE_EMAIL) ) {
			...
			$query = "SELECT userEmail FROM accounts WHERE userEmail='$email'";
		...
		if( !$error ) {
			...
			$query = "INSERT INTO accounts(userId,userName,userEmail,userPass) VALUES('$userId','$name','$email','$password')";
...
?>
 ...
 <form method="post"   action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">All Students Account </h3>
            </div>
            <div class="box-body">
              <!-- Date -->
...
echo '<td width=25>';
            ...
            echo '<a class="btn btn-danger btn-sm"  href="delete_stu_account.php?userId='.$row['userId'].'"><i class="glyphicon glyphicon-remove"> </i>&nbsp;Delete</a>';
            echo "</div>";
            echo '</td>';    
           echo '</tr>';  			
