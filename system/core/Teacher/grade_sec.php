        ...
        <div class="col-xs-12">
		 ...
		 <?php
		  ...
		  $con = mysqli_connect($host,$user,$password,$db);
				 ...
				 $gradef = mysqli_query($con,"select * FROM `student_table` WHERE gender = 'female' AND grade ='$grade'  AND section  ='$sec' "  );
				 $r_gradef = mysqli_num_rows($gradef);
				 
				 
				 $gradem = mysqli_query($con,"select * FROM `student_table` WHERE gender = 'male' AND grade ='$grade'  AND section ='$sec'"   );
          ...
          <div class="box box-solid">
 		  ...
 		  <a href="../../system/core/print.php?grade=<?php  echo $_GET ['grade']?>"  class="btn bg-navy btn-flat  "target="_blank"><i class="glyphicon glyphicon-print"> </i>Print/Export PDF</a> 
          ...
          <div class="box box-widget widget-user-2">
            <!-- Add the bg color to the header using any of the bg-* classes -->
             <div class="widget-user-header bg-aqua-active">
              ...
              <h5 class="widget-user-desc">In Grade  <?php  echo $grade ;?> Section <?php  echo $sec ;?></h5>
            </div>
      ...
      <!-- /.row -->
           ...
           <div class="box">
            ...
            <div class="box-header btn   btn-flat ">
              <h3 class="box-title"> All Students in Grade <?php  echo $grade ;  ?> Section  <?php   echo $sec ;?> </h3>
            </div>
		 ...
		 $select = "SELECT * FROM `student_table` WHERE grade='$grade'  AND section='$sec'  ";
