...
<body class="hold-transition skin-purple sidebar-mini" onload="myFunction()" >
<div class="wrapper">
...
<?php
      ...
      <div class="navbar-custom-menu">
		...
		$select = "SELECT `id`, `position`, `date`, `title`, `message` FROM `noticemsg` order by `date`   ";
           ...
           ?>	 
                  <li><!-- start message -->
                    <a href="../../../system/core/admin/add_new.php">
					     <div class="pull-left">
              ...
              <li class="footer"><a href="../../system/core/admin/add_new.php">See All Messages</a></li>
            </ul>
          </li>
	...
	{ 
           ?>	 
                  <li><!-- start message -->
                    <a href="../../../system/core/admin/upload.php">
					     <div class="box-body">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../../../system/core/admin/logout.php?logout" class="btn btn-default btn-flat">Sign out</a>
                </div> 
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
     ...
     <div class="user-panel">
      ...
      <ul class="sidebar-menu">
		...
		<li>
          <a href="../../../system/core/admin/school_setup.php">
              <span>School Settings  </span>
            <span class="pull-right-container">
              <small class="label pull-right bg-red"> <i class="glyphicon glyphicon-cog"></i> </small>
            </span>
          </a>
        </li>
		<li>
          <a href="../../../system/core/admin/index.php">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../../../system/core/admin/student.php"><i class="glyphicon glyphicon-user "></i><?php echo $lang['Students'];  ?></a></li>
            <li><a href="../../../system/core/admin/teacher.php" ><i class="glyphicon glyphicon-education"></i> <?php echo $lang['Teachers'] ; ?></a></li>
            <li><a href="../../../system/core/admin/employee.php" ><i class="glyphicon glyphicon-asterisk "></i> Other Employees</a></li>

          </ul>
        </li>
        <li>
          <a href="../../../system/core/admin/all_mark_list.php">
            <i class="glyphicon glyphicon-folder-open"></i> <span> <?php  echo $lang['Mark_list'];  ?></span>
            
          </a>
        </li>
        <li>
          <a href="../../../system/core/admin/Sched.php">
            <i class="glyphicon glyphicon-time  "></i> <span>Schedule</span>
            
          </a>
        </li>
		<li>
          <a href="../../../system/core/admin/lesson_plan_entry.php">
       ...
       <li>
        ...
        <li>
         <a href="../../../system/core/admin/subject_entry.php">
      ...
      <a href="../../../system/core/admin/upload.php">
        ...
        <li class="treeview ">
          ...
          <ul class="treeview-menu">
            <li>  <a href="../../../system/core/admin/add_stud_acc.php"><i class="glyphicon glyphicon-user "></i><?php echo $lang['Students'];  ?></a></li>
            <li><a href="../../../system/core/admin/add_teach_acc.php"><i class="glyphicon glyphicon-education"></i> <?php echo $lang['Teachers'] ; ?></a></li>
            <li><a href="../../../system/core/admin/add_admin_acc.php"><i class="glyphicon glyphicon-asterisk "></i> Admin</a></li>
