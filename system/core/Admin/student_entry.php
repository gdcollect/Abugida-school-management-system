...
$insert1 = "INSERT INTO `marklist` (`std_roll_no`,`sec`,`name`,`subject`,`grade`)
           VALUES
		  ('$std_roll_no','$section','$studentName','$subject','$grade')";


 if($run = mysqli_query($con,$insert)&&mysqli_query($con,$insert1)&&mysqli_query($con,$insert1)){
		?>
		   <script>
