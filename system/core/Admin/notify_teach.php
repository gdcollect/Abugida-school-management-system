      ...
      <div class="row">
          ...
          <div class="box box-solid">
           ...
           <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class=""><a href="notify_stud.php"><i class="fa fa-user"></i> Students
                  <span class="label label-primary pull-right"><?php   echo  $stud ;?> </span></a></li>
                <li class="active" ><a  href="notify_teach.php"><i class="fa fa-graduation-cap"></i> Teachers
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Teachers Notifications </h3>
		...
		$select = "SELECT * FROM noticemsg WHERE position='Teachers'";
