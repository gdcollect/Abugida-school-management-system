	...
	<?php
	 $con = mysqli_connect($host,$user,$password,$db);
		if(isset($_POST['submit'])!="")
		{
		  ...
		  (name,type,Elementary,High,Preparatory,logo,phone,address)
		  VALUES('$school_name','$type1','$Elementary','$High','$Preparatory','$logo','$phone' ,'$address')
		  ");
		 if($insert)
		 {
	?>
		...
		<div>
			<div class="nav-tabs-custom">                        
				<ul class="nav nav-tabs">
					...
					</li> <li class=""><a href="#more" data-toggle="tab">More  </a></li> 
				</ul>
        ...
        <div class="tab-pane active" id="home">			
			...
			<div class="box box-widget widget-user">
				...
				<div class="widget-user-image">
					<img class="img"  src="../../../dist/logo/<?php  echo $row['logo'] ;?>" alt="User Avatar">
				</div>
								...
								<div class="box-body">
									<div id="external-events">
										<form enctype="multipart/form-data" action="#" name="form" method="post">
											...
											<div style="width: 70%; " class="alert alert-info alert-dismissible">
												<h4>School Type </h4>
												<select style="width: 80%;"  class="form-control"  id="chapter" name="type" required>
