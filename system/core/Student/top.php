        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-danger"><?php   echo  $stud  ;?></span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have <?php   echo  $stud  ;?> Notifications</li>
              <li>
				...
				$select = "SELECT `id`, `position`, `date`, `title`, `message` 
						   FROM `noticemsg` 
						   WHERE `position`='Students' 
						   order by `date`   ";
           ...
           ?>	 
                  <li><!-- start message -->
                    <a href="../../../system/core/student/view_notice.php?id=<?php  echo $row['id'] ?>">
					     <div class="pull-left">
              ...
              <li class="footer"><a href="../../system/core/student/add_new.php">See All Messages</a></li>
            </ul>
          </li>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../../../system/core/student/logout.php?logout" class="btn btn-default btn-flat">Sign out</a>
                </div> 
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
     ...
     <div class="user-panel">
      ...
      <ul class="sidebar-menu">
		...
		<li>
          <a href="../../../system/core/student/index.php">
        ...
        <li>
          <a href="../../../system/core/student/all_mark_list.php">
            <i class="glyphicon glyphicon-folder-open"></i> <span>Grades</span>
            
          </a>
        </li>
         
       <li>
          <a href="../../../system/core/student/AttendenceReport.php">
        ...
        <li>
      <a href="../../../system/core/student/upload.php">
            <i class="glyphicon glyphicon-cloud-download"></i> <span>File Downloads</span>
            
          </a>
        </li>
        <li>
         <a href="../../../system/core/student/add_new.php">
        ...
        <li class="treeview ">
          <a href="#">
            <i class="glyphicon glyphicon-user "></i> <span> Account Management</span>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="glyphicon glyphicon-education"></i> View Profile</a></li>
